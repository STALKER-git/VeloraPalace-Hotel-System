...
const code = `import { createContext, useContext, useState, ReactNode } from 'react';
...
interface Translations {
  ...
  dashboard: {
    ...
    overview: string; rooms: string; users: string; bookings: string; restaurant: string; venues: string; orders: string;
