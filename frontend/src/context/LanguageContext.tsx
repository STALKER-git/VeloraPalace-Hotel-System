...
interface Translations {
  ...
  clientDashboard: {
    ...
    date: string; time: string; cancelRes: string; editRes: string; editResTitle: string; cancelEdit: string;
